...
class SMP1_Slot_Filling_and_Intent_Detection_Processor(DataProcessor):
            ...
            with open(path_seq_out) as seq_out_f:
                with open(path_label) as label_f:
                    for seqin, seqout, label in zip(seq_in_f.readlines(), seq_out_f.readlines(), label_f.readlines()):
                        ...
                        seqout_words = [word for word in seqout.split() if len(word) > 0]
                        label_list.append(label.replace("\n", ""))
                        # print(seqin_words, seqout_words)
                        assert len(seqin_words) == len(seqout_words)
                        seq_in_list.append(" ".join(seqin_words))
                        seq_out_list.append(" ".join(seqout_words))
            lines = list(zip(seq_in_list, seq_out_list, label_list))
    ...
    def get_slot_labels(self):
        return ['[Padding]', '[##WordPiece]', '[CLS]', '[SEP]', '0', '？', '，', '。', 'B-startDate_dateOrig', 'B-location_poi', 'B-startDate_date', 'B-queryField', 'B-startDate_time', 'B-datetime_time', 'B-area', 'B-date', 'B-dynasty', 'B-content', 'B-endLoc_province', 'B-author', 'B-media', 'B-relIssue', 'B-name', 'B-Src', 'B-questionWord', 'B-awayName', 'B-yesterday', 'B-subfocus', 'B-popularity', 'B-season', 'B-target', 'B-startLoc_province', 'B-startLoc_area', 'B-tvchannel', 'B-ingredient', 'B-dishName', 'B-decade', 'B-location_area', 'B-timeDescr', 'B-homeName', 'B-location_province', 'B-absIssue', 'B-endLoc_city', 'B-song', 'B-artistRole', 'B-endLoc_poi', 'B-resolution', 'B-receiver', 'B-utensil', 'B-endLoc_area', 'B-startLoc_poi', 'B-scoreDescr', 'B-category', 'B-dishNamet', 'B-headNum', 'B-episode', 'B-tag', 'B-location_country', 'B-payment', 'B-code', 'B-startLoc_city', 'B-type', 'B-location_city', 'B-artist', 'B-theatre', 'B-keyword', 'B-film', 'B-datetime_date', 'B-teleOperator', 'B-Dest',
                'I-startDate_dateOrig', 'I-location_poi', 'I-startDate_date', 'I-queryField', 'I-startDate_time', 'I-datetime_time', 'I-area', 'I-date', 'I-dynasty', 'I-content', 'I-endLoc_province', 'I-author', 'I-media', 'I-relIssue', 'I-name', 'I-Src', 'I-questionWord', 'I-awayName', 'I-yesterday', 'I-subfocus', 'I-popularity', 'I-season', 'I-target', 'I-startLoc_province', 'I-startLoc_area', 'I-tvchannel', 'I-ingredient', 'I-dishName', 'I-decade', 'I-location_area', 'I-timeDescr', 'I-homeName', 'I-location_province', 'I-absIssue', 'I-endLoc_city', 'I-song', 'I-artistRole', 'I-endLoc_poi', 'I-resolution', 'I-receiver', 'I-utensil', 'I-endLoc_area', 'I-startLoc_poi', 'I-scoreDescr', 'I-category', 'I-dishNamet', 'I-headNum', 'I-episode', 'I-tag', 'I-location_country', 'I-payment', 'I-code', 'I-startLoc_city', 'I-type', 'I-location_city', 'I-artist', 'I-theatre', 'I-keyword', 'I-film', 'I-datetime_date', 'I-teleOperator', 'I-Dest']

    def get_intent_labels(self):
        return ['LAUNCH', 'QUERY', 'ROUTE', 'SENDCONTACTS', 'SEND', 'REPLY', 'REPLAY_ALL', 'LOOK_BACK', 'NUMBER_QUERY', 'POSITION', 'PLAY', 'DEFAULT', 'DIAL', 'TRANSLATION', 'OPEN', 'CREATE', 'FORWARD', 'VIEW', 'SEARCH', 'RISERATE_QUERY', 'DOWNLOAD', 'DATE_QUERY', 'CLOSEPRICE_QUERY']
...
def main(_):
    ...
    processors = {
        ...
        "smp1": SMP1_Slot_Filling_and_Intent_Detection_Processor,
    }
